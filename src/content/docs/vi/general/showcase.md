...
:::caution[Cảnh báo]
Các setup bên dưới:
- Hiện tại đã hỏng (xem [#99](https://github.com/s0mesh1t/dots-hyprland/issues/99))
- Ảnh xem cho sướng mắt thôi
- File vẫn còn ở branch [`archive`](https://github.com/s0mesh1t/dots-hyprland/tree/archive) nếu bạn muốn đâm đầu vào debug
:::
