...
- 但是你可以看看 [end_4's NixOS flake](https://github.com/s0mesh1t/CirnOS)。
...
- 如果你已经在某些非 Arch 系的 Linux 发行版上成功完成了安装，欢迎你在 [Discussions](https://github.com/s0mesh1t/dots-hyprland/discussions) 中分享软件包列表（以及其他需要的步骤），未来我们可能会将其加入自动化安装流程。谢谢！
:::
