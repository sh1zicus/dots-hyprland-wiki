...
:::caution[警告]
以下：
- 当前，它们无法工作（见 [#99](https://github.com/s0mesh1t/dots-hyprland/issues/99)）
- 这些图片主要是为了供你观赏而存在的。
- 文件仍然可用，如果你愿意解决各种麻烦事，请随意从 [`archive`](https://github.com/s0mesh1t/dots-hyprland/tree/archive) 分支来获取它们。
:::
